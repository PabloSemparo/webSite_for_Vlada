        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-foreground/80 leading-relaxed">
              <p>
                Vladusik Pampusik is a contemporary artist based in New York, working primarily
              ...
              <p>
                With over a decade of professional practice, Vlada's paintings have been
          ...
          <div className="relative">
            <div className="aspect-[3/4] overflow-hidden rounded-lg shadow-xl">
              <img 
                src={artistPhoto}
                alt="Vladusik Pampusik in her studio"
